...
libvirt-STOCK-DEVEL-RPMS += systemd-devel libnl3-devel iptables-services libgcrypt-devel netcf-devel
ALL += libvirt
IN_NODEREPO += libvirt
...
libvirt-python-STOCK-DEVEL-RPMS += gnutls-utils nmap-ncat pm-utils gettext gettext-devel
