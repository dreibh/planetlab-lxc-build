...
nornet-nn-GITPATH               := git://github.com/dreibh/nornet-nn.git@nornet-rel0.9.7.0004
...
# ##### NorNet ########################
linux-GITPATH                   := git://github.com/dreibh/planetlab-kernel.git@nornet-rel0.9.7.0001
...
# !!! Using NorNet customisation! !!! plcapi-GITPATH                  := git://git.planet-lab.org/plcapi.git@plcapi-5.3-9
drupal-GITPATH                  := git://git.onelab.eu/drupal.git@drupal-4.7-16
# !!! Using NorNet customisation! !!! plewww-GITPATH                  := git://git.onelab.eu/plewww.git@plewww-5.2-6
...
###
# !!! Using NorNet customisation! !!! bootcd-GITPATH                  := git://git.onelab.eu/bootcd.git@bootcd-5.3-3
