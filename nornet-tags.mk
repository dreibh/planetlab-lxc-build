...
lxc-userspace-GITPATH       := git://git.onelab.eu/lxc-userspace.git@lxc-userspace-2.0-0
transforward-GITPATH        := git://git.onelab.eu/transforward.git@transforward-0.1-12
...
# !!! Using NorNet customisation! !!! nodemanager-GITPATH             := git://git.onelab.eu/nodemanager.git@nodemanager-master
#
...
vsys-GITPATH                := git://git.onelab.eu/vsys.git@vsys-0.99-4
...
# !!! Using NorNet customisation! !!! plcapi-GITPATH                  := git://git.onelab.eu/plcapi.git@plcapi-master
drupal-GITPATH              := git://git.onelab.eu/drupal.git@drupal-4.7-17
# !!! Using NorNet customisation! !!! plewww-GITPATH                  := git://git.onelab.eu/plewww.git@plewww-master
...
# !!! Using NorNet customisation! !!! bootmanager-GITPATH             := git://git.onelab.eu/bootmanager.git@bootmanager-master
...
# !!! Using NorNet customisation! !!! bootcd-GITPATH                  := git://git.onelab.eu/bootcd.git@bootcd-master
