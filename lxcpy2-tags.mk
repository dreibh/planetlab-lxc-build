...
nodemanager-GITPATH         := git://git.onelab.eu/nodemanager.git@nodemanager-5.2-20
#
...
plcapi-GITPATH              := git://git.onelab.eu/plcapi.git@plcapi-5.4-2
drupal-GITPATH              := git://git.onelab.eu/drupal.git@drupal-4.7-17
plewww-GITPATH              := git://git.onelab.eu/plewww.git@plewww-5.2-9
...
pyplnet-GITPATH             := git://git.onelab.eu/pyplnet.git@pyplnet-4.3-20
...
myplc-GITPATH               := git://git.onelab.eu/myplc.git@myplc-5.3-5
#
